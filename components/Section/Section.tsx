    ...
    <SectionContextProvider bgColor={bg} width={width}>
      <Component
        ...
        className={clsx({
          ...
          "pt-10 md:pt-10": topSpace === "s" || isDefault(topSpace),
          "pt-10 md:pt-20": topSpace === "m",
          "pt-12 md:pt-28": topSpace === "l",
          "pt-16 md:pt-44": topSpace === "xl",
          "pt-24 md:pt-60": topSpace === "xxl",
          "pb-10 md:pb-10": bottomSpace === "s" || isDefault(bottomSpace),
          "pb-12 md:pb-20": bottomSpace === "m",
          "pb-16 md:pb-32": bottomSpace === "l",
          "pb-24 md:pb-44": bottomSpace === "xl",
